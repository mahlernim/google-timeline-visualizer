...
- Makes it easy to create another video after export without clearing Timeline data, global settings, or saved presets.
- Shows Timeline file size and restores direct access to the backup and restore guide.
- Explains the limited raw-data window, enforces its actual date bounds, and uses inclusive Recent day recap titles.
- Improves trip detection wording, deterministic suggestion ranking, localized destination titles, and unnamed fallbacks.
