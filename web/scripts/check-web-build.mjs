...
const demo = readFileSync(resolve(root, 'demo-mahlerlab.mp4'));
...
if (statSync(resolve(root, 'demo-mahlerlab.webp')).size > 60 * 1024) throw new Error('Demo poster exceeds 60 KiB');
